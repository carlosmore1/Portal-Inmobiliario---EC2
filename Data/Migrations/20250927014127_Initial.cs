        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Codigo = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    Titulo = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    Imagen = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Inmueble_Metros_Pos", "MetrosCuadrados > 0");
                    table.CheckConstraint("CK_Inmueble_Precio_Pos", "Precio > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Visita_RangoValido", "FechaInicio < FechaFin");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 2, "Lima", "DEP-001", "Av. Central 123", 2, null, 75.0, 120000m, 0, "Departamento céntrico" },
                    { 2, true, 3, "Arequipa", "CAS-010", "Jr. Flores 456", 3, null, 140.0, 240000m, 1, "Casa familiar con patio" },
                    { 3, true, 1, "Lima", "OFI-021", "Calle Tech 789", 0, null, 55.0, 95000m, 2, "Oficina moderna" },
                    { 4, true, 1, "Trujillo", "LOC-115", "Esq. Comercio 15", 0, null, 90.0, 180000m, 3, "Local comercial en esquina" }
                });
